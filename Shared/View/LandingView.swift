...
struct LandingView: View {
    ...
    @State var homeItems: [HomeItemModel] = [
        .init(iconName: "our vision icon", optionName: "Our Vision"), .init(iconName: "Meet our team icon", optionName: "Meet Our Team"), .init(iconName: "Choose your tour icon", optionName: "Choose Your Tour"), .init(iconName: "Special event icon", optionName: "Special Event"), .init(iconName: "Support us icon", optionName: "Support Us")
    ]
                    ...
                    ScrollView {
                        LazyVGrid(columns: [GridItem(.flexible())], alignment: .leading) {
                            ForEach(homeItems) { item in
                                NavigationLink {
                                    if item.optionName == "Our Vision" {
                                        OurVisionView()
                                            .navigationBarHidden(true)
                                    }
                                    if item.optionName == "Meet Our Team" {
                                        MeetOutTeamView()
                                            .navigationBarHidden(true)
                                    }
                                    if item.optionName == "Support Us" {
                                        SupportUsView()
                                            .navigationBarHidden(true)
                                    }
